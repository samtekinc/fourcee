...
export type Mutation = {
  ...
  createTerraformDriftCheckWorkflowRequest: TerraformDriftCheckWorkflowRequest;
  createTerraformExecutionWorkflowRequest: TerraformExecutionWorkflowRequest;
...
export type MutationCreateTerraformDriftCheckWorkflowRequestArgs = {
  terraformDriftCheckWorkflowRequest: NewTerraformDriftCheckWorkflowRequest;
};


export type MutationCreateTerraformExecutionWorkflowRequestArgs = {
...
export type NewTerraformDriftCheckWorkflowRequest = {
  moduleAssignmentId: Scalars['ID'];
};

export type NewTerraformExecutionWorkflowRequest = {
...
export type OrganizationalUnitQuery = { __typename?: 'Query', organizationalUnit: { __typename?: 'OrganizationalUnit', orgUnitId: string, name: string, hierarchy: string, parentOrgUnitId?: string | null, orgDimension: { __typename?: 'OrganizationalDimension', orgDimensionId: string, name: string }, downstreamOrgUnits: { __typename?: 'OrganizationalUnits', items: Array<{ __typename?: 'OrganizationalUnit', orgUnitId: string, name: string, hierarchy: string, parentOrgUnitId?: string | null } | null> }, orgUnitMemberships: { __typename?: 'OrganizationalUnitMemberships', items: Array<{ __typename?: 'OrganizationalUnitMembership', orgDimensionId: string, orgAccountId: string, orgAccount: { __typename?: 'OrganizationalAccount', orgAccountId: string, name: string, cloudPlatform: CloudPlatform, cloudIdentifier: string } } | null> }, modulePropagations: { __typename?: 'ModulePropagations', items: Array<{ __typename?: 'ModulePropagation', modulePropagationId: string, name: string, description: string, moduleGroup: { __typename?: 'ModuleGroup', moduleGroupId: string, name: string }, moduleVersion: { __typename?: 'ModuleVersion', moduleVersionId: string, name: string } } | null> } } };
...
export type CreateTerraformDriftCheckWorkflowRequestMutationVariables = Exact<{
  moduleAssignmentId: Scalars['ID'];
}>;


export type CreateTerraformDriftCheckWorkflowRequestMutation = { __typename?: 'Mutation', createTerraformDriftCheckWorkflowRequest: { __typename?: 'TerraformDriftCheckWorkflowRequest', terraformDriftCheckWorkflowRequestId: string } };

export type CreateTerraformExecutionWorkflowRequestMutationVariables = Exact<{
  moduleAssignmentId: Scalars['ID'];
  destroy: Scalars['Boolean'];
}>;


export type CreateTerraformExecutionWorkflowRequestMutation = { __typename?: 'Mutation', createTerraformExecutionWorkflowRequest: { __typename?: 'TerraformExecutionWorkflowRequest', terraformExecutionWorkflowRequestId: string } };
...
export const CreateTerraformDriftCheckWorkflowRequestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"createTerraformDriftCheckWorkflowRequest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"moduleAssignmentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTerraformDriftCheckWorkflowRequest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"terraformDriftCheckWorkflowRequest"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"moduleAssignmentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"moduleAssignmentId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"terraformDriftCheckWorkflowRequestId"}}]}}]}}]} as unknown as DocumentNode<CreateTerraformDriftCheckWorkflowRequestMutation, CreateTerraformDriftCheckWorkflowRequestMutationVariables>;
export const CreateTerraformExecutionWorkflowRequestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"createTerraformExecutionWorkflowRequest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"moduleAssignmentId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"destroy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTerraformExecutionWorkflowRequest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"terraformExecutionWorkflowRequest"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"moduleAssignmentId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"moduleAssignmentId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"destroy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"destroy"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"terraformExecutionWorkflowRequestId"}}]}}]}}]} as unknown as DocumentNode<CreateTerraformExecutionWorkflowRequestMutation, CreateTerraformExecutionWorkflowRequestMutationVariables>;