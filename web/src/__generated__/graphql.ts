...
export type TerraformDriftCheckRequestPlanExecutionRequestArgs = {
  withOutputs?: InputMaybe<Scalars['Boolean']>;
};
...
export type TerraformExecutionRequestApplyExecutionRequestArgs = {
  withOutputs?: InputMaybe<Scalars['Boolean']>;
};


export type TerraformExecutionRequestPlanExecutionRequestArgs = {
  withOutputs?: InputMaybe<Scalars['Boolean']>;
};
