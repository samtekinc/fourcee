...
export type OrgDimensionQuery = { __typename?: 'Query', orgDimension: { __typename?: 'OrgDimension', id: string, name: string, rootOrgUnitID: string, orgUnits: Array<{ __typename?: 'OrgUnit', id: string, name: string, parentOrgUnitID?: string | null, hierarchy: string }> } };

export type OrgDimensionsQueryVariables = Exact<{ [key: string]: never; }>;


export type OrgDimensionsQuery = { __typename?: 'Query', orgDimensions: Array<{ __typename?: 'OrgDimension', id: string, name: string, orgUnits: Array<{ __typename?: 'OrgUnit', id: string }> }> };
