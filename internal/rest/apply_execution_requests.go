...
func (r *OrganizationsRouter) getApplyExecutionRequests(c *gin.Context) {
...
func (r *OrganizationsRouter) getApplyExecutionRequest(c *gin.Context) {
...
func (r *OrganizationsRouter) putApplyExecutionRequest(c *gin.Context) {
